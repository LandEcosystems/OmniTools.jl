...
#SBATCH --nodelist=node-r6-he09      # Specify the node with A40 or A100 GPUs
...
#SBATCH -o /Net/Groups/BGI/tscratch/lalonso/SindbadOutput/fALLs_slurm-%A_%a.out
...
#
################
julia --project --heap-size-hint=16G exp_hybridfALL.jl
