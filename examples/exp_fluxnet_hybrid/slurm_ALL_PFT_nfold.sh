#!/bin/bash
#SBATCH --job-name=HyALL_PFT
#SBATCH --ntasks=8
#SBATCH --cpus-per-task=17
#SBATCH --mem-per-cpu=500
#SBATCH --time=14:50:00
#SBATCH --array=0-9  # 10 jobs
#SBATCH -o /ptmp/lalonso/slurmOutput/HyALL_PFT-%A_%a.out
...
julia --project --heap-size-hint=16G exp_hybridfALL_PFT_nfold.jl $nfold $nlayer $neuron $batchsize